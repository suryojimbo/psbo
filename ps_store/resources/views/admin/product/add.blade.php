            ...
            <form role="form" action="{{ url('admin/product') }}" method="POST" enctype="multipart/form-data">
              ...
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <input type="number" class="form-control" placeholder="Enter Stocks" name="stock">
                </div>
                ...
                <div class="form-group">
                  ...
                  <input type="file" class="form-control" placeholder="Upload Photo of Product" name="file">
                </div>
